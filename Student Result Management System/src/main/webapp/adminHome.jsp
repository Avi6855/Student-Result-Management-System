...
<body>
<img src="shivaji_university.jpeg"  align="left"width="100" height="100">
<center><img src="mid_logo.jpeg" width="100" height="100">
<img src="logo_nck.png" align="right"  width="100" height="100"></center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">PRN Number</label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="prnNo">
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">PRN Number</label>
                                    <div class="col-md-6">
                                        <input type="text"class="form-control" name="prnNo">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">Advanced Java 
                                    </label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">ASP.Net 
                                    </label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">Software Project Management</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">Machine Learning Part-II </label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">English for communication- IV</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">PHP Part-II</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">Project Work
                                    </label>
                                    <div class="col-md-6">
...
<section>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th>Machine Learning Part-II</th>
          <th>English for communication- IV</th>
          <th>PHP Part-II</th>
          <th>Project Work</th>
        </tr>
      </thead>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Designed & Developed by Avinash Patil & Avishkar Devkar</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Avinash Patil & Avishkar Devkar :: 2024-2029</h5></center> 
  <hr class="new1">
<br>
</body>
</html>